# Generated by Powerlevel10k configuration wizard on 2021-02-23 at 17:10 CET.
...
function p10k-on-post-widget() {
  ...
  #if [[ -v P10K_ENABLE_KUBECONTEXT ]] || (( P9K_COMMANDS[(I)(|*$z)kubectl] )); then
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=015
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_BACKGROUND=196
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGE_FOREGROUND=015
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGE_BACKGROUND=021
